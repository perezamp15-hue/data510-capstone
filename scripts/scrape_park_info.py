...
def run():
    ...
    # Added active=true to guarantee the fieldInfo properties hydrate cleanly
    url = "https://statsapi.mlb.com/api/v1/venues?sportId=1&active=true&hydrate=location,fieldInfo"
    try:
        ...
        with engine.begin() as conn:
            for _, row in df.iterrows():
                ...
                """), row.to_dict())
        print(f"Venues and fields database dimensions refreshed successfully.")
