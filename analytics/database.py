...
def test_database_connection() -> dict[str, Any]:
    """Test PostgreSQL and return safe connection information."""
    try:
        ...
        raise DatabaseConnectionError(
            "Unable to connect to the Railway PostgreSQL database."
        ) from exc
...
def read_scalar(
    ...
    """Execute a query and return its first scalar result."""
    try:
        with get_engine().connect() as connection:
        ...
        raise DatabaseConnectionError(
            "A PostgreSQL scalar query failed."
        ) from exc
